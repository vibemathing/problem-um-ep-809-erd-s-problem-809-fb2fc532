...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-809-erd-s-problem-809-fb2fc532-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-809"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-809-erd-s-problem-809-fb2fc532-v1",
      "problem_contract_sha256": "481c81c04805e683e17e82278b926f00624adffec2aadb12d5875ec26d7b003a",
      "problem_id": "problem:um-ep-809-erd-s-problem-809-fb2fc532",
      "route_id": "route:um-ep-809-erd-s-problem-809-fb2fc532-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-809-erd-s-problem-809-fb2fc532-source-fidelity-01",
      "graph_id": "graph:um-ep-809-erd-s-problem-809-fb2fc532-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-809-erd-s-problem-809-fb2fc532-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-809-erd-s-problem-809-fb2fc532-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $k\\geq 3$ and define $F_k(n)$ to be the minimal $r$ such that there is a graph $G$ on $n$ vertices with $\\lfloor n^2/4\\rfloor+1$ many edges such that the edges can be $r$-coloured so that every subgraph isomorphic to $C_{2k+1}$ has no colour repeating on the edges. Is it true that $ F_k(n)\\sim n^2/8? $"
          },
          "statement_sha256": "148174927f495f8c9439552c5bdcb3e4ec7a8ef371d09545a222e5475f28fad2"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-809-erd-s-problem-809-fb2fc532-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-809-erd-s-problem-809-fb2fc532-root",
      "route_id": "route:um-ep-809-erd-s-problem-809-fb2fc532-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-809-4d0f4faa19f7",
        "url": "https://www.unsolvedmath.com/problems/EP-809"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
